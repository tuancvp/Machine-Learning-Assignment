...
class knn:
	...
	def loadData(self, fn_data="./knn-dataset/trainData{}.csv", fn_label="./knn-dataset/trainLabels{}.csv"):
		X_train = []
		Y_train = []
	...
	def plot_visualization(self, k_choice, k_to_accuracies):
